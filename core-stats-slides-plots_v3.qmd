...
global_height <- data.frame(dist = dist_normal(169, 10)) %>%
    ...
    stat_slab(fill = "gray85", colour = "#0072CF", alpha =0.7) +
...
```{r, generate data for height sample}
set.seed(2404)
...
global_height2 <- global_height +
  theme_classic(base_size=15)

landscape.ggsave(plot = global_height2, filename = "plots/cs1-global-height-full.png")
```

### Distributions

```{r, global height with mean/meanvar}
global_height_mean <- data.frame(dist = dist_normal(169, 10)) %>%
    ggplot(aes(xdist = dist)) +
    stat_slab(fill = "gray85", colour = "#0072CF", alpha =0.7) +
    scale_x_continuous(breaks = seq(140, 200, by = 10), limits = c(140, 200)) +
...
global_height_meanvar <- global_height_mean +
    geom_segment(x = 158, y = 0.4, xend = 180, yend = 0.4, arrow = arrow(length = unit(0.03, "npc"), ends = "both"))

landscape.ggsave(plot = global_height_mean, filename = "plots/cs1-global-height-mean.png")
landscape.ggsave(plot = global_height_meanvar, filename = "plots/cs1-global-height-meanvar.png")
```

```{r, save mini global height with mean/var}
global_height_meanvar_quarter <- global_height_meanvar + theme_classic()

quarter.ggsave(plot = global_height_meanvar_quarter, filename = "plots/cs1-global-height-meanvar-quarter.png") 
```
...
other_distributions <- ggplot(df, aes(xdist = dist)) +
  stat_slab(fill = "gray85", colour = "#0072CF", alpha =0.7) + 
  facet_wrap(facets = vars(name), scales = "free", strip.position = "bottom") +
...
```{r, classical hypothesis testing f distribution}
#quarter.ggsave(plot = global_height, filename = "plots/cs1-global-height-quarter.png")

f_dist <- ggplot(NULL, aes(c(0,6.5))) +
  geom_area(stat = "function", fun = df, args=list(df1 = 8, df2 = 15), fill = "grey95", colour = "#0072CF", linewidth = 1, xlim = c(0,6.5)) +
...
```{r, classical hypothesis testing f distribution 2}

f_dist_large <- ggplot(NULL, aes(c(0,6.5))) +
  geom_area(stat = "function", fun = df, args=list(df1 = 8, df2 = 15), fill = "grey95", colour = "#0072CF", linewidth = 1, xlim = c(0,6.5)) +
  geom_area(stat = "function", fun = df, args=list(df1 = 8, df2 = 15), fill = "#EA7125", colour = "#0072CF", linewidth = 1, xlim = c(3, 6.5)) +
  labs(title = "F-statistic distribution", x = "F", y = "probability density") +
  theme_classic(base_size=12)

quarter.ggsave(plot = f_dist_large, filename = "plots/cs1-f-distribution-largef.png")

```

```{r, classical hypothesis testing f distribution 3}

f_dist_small <- ggplot(NULL, aes(c(0,6.5))) +
  geom_area(stat = "function", fun = df, args=list(df1 = 8, df2 = 15), fill = "grey95", colour = "#0072CF", linewidth = 1, xlim = c(0,6.5)) +
  geom_area(stat = "function", fun = df, args=list(df1 = 8, df2 = 15), fill = "#EA7125", colour = "#0072CF", linewidth = 1, xlim = c(1, 6.5)) +
  labs(title = "F-statistic distribution", x = "F", y = "probability density") +
  theme_classic(base_size=12)

quarter.ggsave(plot = f_dist_small, filename = "plots/cs1-f-distribution-smallf.png")
...
intuitive_original <- ggplot(anova_example, aes(x = group, y = response)) +
  ...
  stat_summary(fun.y = mean, geom = "errorbar", aes(ymax = ..y.., ymin = ..y.., colour = group), linewidth=1) +
...
anova_small_spread <- anova_example %>%
  mutate(response = response + 0.7*(group_mean-response))

intuitive_small_spread <- ggplot(anova_small_spread, aes(x = group, y = response)) +
  geom_point(aes(colour = group), size = 3, alpha = 0.8) +
  stat_summary(fun = mean, geom = "errorbar", aes(ymax = ..y.., ymin = ..y.., colour = group), linewidth=1) +
  scale_y_continuous(limits = c(0, 12), breaks = seq(0, 12, by = 2)) +
  scale_colour_manual(values = cols) +
  theme_classic(base_size = 15) +
  theme(legend.position = "none") +
...
anova_large_spread <- anova_example %>%
  mutate(response = response + 0.75*(response-group_mean))
...
```{r, between group variance means with multiple points per mean}

between_group_multiple <- ggplot(anova_example_aug, aes(x = 0, y = mean_response, colour = group)) +
  geom_hline(yintercept = 6, linetype = "dashed") +
  geom_point(aes(group = id), position = position_dodge(width = 0.5), size = 3, alpha = 0.8) +
  scale_y_continuous(limits = c(0, 12), breaks = seq(0, 12, by = 2)) +
  scale_x_continuous(limits = c(-1,1)) +
  scale_colour_manual(values = cols) +
  theme_classic(base_size = 15) +
  theme(legend.position = "none") +
  labs(title = "Between-group variance", x = "", y = "response")

square.ggsave(plot = between_group_multiple, filename = "plots/cs2-between-group-multiple.png")
```
...
between_group_var <- between_group +
  geom_segment(aes(xend = group, y = 6, yend = group_mean, colour = group),
               arrow = arrow(ends = "both", length = unit(0.075, "inches"),
...
ggplot(aes(x = number, y = response)) +
  ...
  theme(legend.position = "none") +
  labs(title = "Between-group variance", x = "group", y = "response") +
  annotate(geom = "segment", x=1.7, xend=2.3, y=6.530115	, yend=6.530115	, colour = cols[1], linewidth=1) +
  annotate(geom = "segment", x=1.7, xend=2.3, y=8.323681	, yend=8.323681	, colour = cols[2], linewidth=1) +
  annotate(geom = "segment", x=1.7, xend=2.3, y=3.784875	, yend=3.784875	, colour = cols[3], linewidth=1)
...
within_group <- ggplot(anova_example, aes(x = group, y = response)) +
  geom_hline(yintercept = 6, linetype = "dashed") +
  stat_summary(fun.y = mean, geom = "errorbar", aes(ymax = ..y.., ymin = ..y..), colour = "lightgrey", linewidth = 1) +
  geom_point(aes(colour = group), size = 3, alpha = 0.8) +
  scale_y_continuous(limits = c(0, 12), breaks = seq(0, 12, by = 2)) +
  scale_colour_manual(values = cols) +
  theme_classic(base_size = 15) +
  theme(legend.position = "none") +
  labs(title = "Within-group variance", x = "group", y = "response") +  
  geom_segment(aes(xend = group, y = (group_mean+1.9), yend = (group_mean-1.9), colour = group),
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), linewidth=1,
...
```{r, demoing a residual}
anova_example %>% 
  filter(group == "A") %>% 
  summarise(max(response))
datapoint1 <- 8.188008	

mean1 <- anova_example$group_mean[1]

residual_expl1 <- ggplot(anova_example, aes(x = group, y = response)) +
  geom_hline(yintercept = 6, linetype = "dashed") +
  stat_summary(fun.y = mean, geom = "errorbar", aes(ymax = ..y.., ymin = ..y..), colour = "lightgrey", linewidth = 1) +
  geom_point(colour="#999999", size = 3, alpha = 0.8) +
  scale_y_continuous(limits = c(0, 12), breaks = seq(0, 12, by = 2)) +
  #scale_colour_manual(values = cols) +
  theme_classic(base_size = 15) +
  theme(legend.position = "none") +
  labs(title = "Differences between data and mean...", x = "group", y = "response") +  
  geom_segment(aes(x=1, y=mean1, yend=datapoint1),
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), linewidth=1, colour = "#EA7125", position = position_nudge(x = 0.15)) +
  geom_point(x=1, y=datapoint1, colour = "#EA7125", size = 3)

residual_expl2 <- ggplot(anova_example_aug, aes(x = group, y = .resid)) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  stat_summary(fun.y = mean, geom = "errorbar", aes(ymax = ..y.., ymin = ..y..), colour = "lightgrey", linewidth = 1) +
  geom_point(size = 3, alpha = 0.8, colour="#999999") +
  scale_y_continuous(limits = c(-6, 6), breaks = seq(-6, 6, by = 2)) +
  #scale_colour_manual(values = cols) +
  theme_classic(base_size = 15) +
  theme(legend.position = "none") +
  labs(title = "... plotted by themselves", x = "group", y = "residuals") +  
  geom_segment(aes(x=1, y=0, yend=(datapoint1-mean1)),
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), linewidth=1, colour = "#EA7125", position = position_nudge(x = 0.15)) +
  geom_point(x=1, y=(datapoint1-mean1), colour = "#EA7125", size = 3)

square.ggsave(plot = residual_expl1, filename = "plots/cs2-residual-expl1.png")
square.ggsave(plot = residual_expl2, filename = "plots/cs2-residual-expl2.png")
```

```{r, demoing residuals step 2}
datapoint1_1 <- 5.205632

residual_expl3 <- residual_expl1 +
    geom_segment(aes(x=1, y=mean1, yend=datapoint1_1),
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), linewidth=1, colour = "#EA7125", position = position_nudge(x = 0.2)) +
  geom_point(x=1, y=datapoint1_1, colour = "#EA7125", size = 3)
  
residual_expl4 <- residual_expl2  +  
  geom_segment(aes(x=1, y=0, yend=(datapoint1_1-mean1)),
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), linewidth=1, colour = "#EA7125", position = position_nudge(x = 0.2)) +
  geom_point(x=1, y=(datapoint1_1-mean1), colour = "#EA7125", size = 3)

square.ggsave(plot = residual_expl3, filename = "plots/cs2-residual-expl3.png")
square.ggsave(plot = residual_expl4, filename = "plots/cs2-residual-expl4.png")
```

```{r, demoing residuals step 3}
anova_example %>% 
  filter(group == "C") %>% 
  summarise(min(response))
datapoint2 <- 6.790676
mean2 <- anova_example$group_mean[11]

datapoint3 <- 4.415876
mean3 <- anova_example$group_mean[21]

residual_expl5 <- residual_expl3 +
  geom_segment(aes(x=2, y=mean2, yend=datapoint2),
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), linewidth=1, colour = "#0072CF", position = position_nudge(x = 0.15)) +
  geom_point(x=2, y=datapoint2, colour = "#0072CF", size = 3)+
  geom_segment(aes(x=3, y=mean3, yend=datapoint3),
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), linewidth=1, colour = "#55A51C", position = position_nudge(x = 0.15)) +
  geom_point(x=3, y=datapoint3, colour = "#55A51C", size = 3)

residual_expl6 <- residual_expl4 +
  geom_segment(aes(x=2, y=0, yend=(datapoint2-mean2)),
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), linewidth=1, colour = "#0072CF", position = position_nudge(x = 0.15)) +
  geom_point(x=2, y=(datapoint2-mean2), colour = "#0072CF", size = 3) +
  geom_segment(aes(x=3, y=0, yend=(datapoint3-mean3)),
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), linewidth=1, colour = "#55A51C", position = position_nudge(x = 0.15)) +
  geom_point(x=3, y=(datapoint3-mean3), colour = "#55A51C", size = 3)

square.ggsave(plot = residual_expl5, filename = "plots/cs2-residual-expl5.png")
square.ggsave(plot = residual_expl6, filename = "plots/cs2-residual-expl6.png")
```
...
ggplot(aes(x = "between-group", y = response, colour = group)) +
  ...
  theme_classic(base_size = 15) +
  theme(legend.position = "none") +
  annotate(geom = "segment", x=0.7, xend=1.3, y=(6.530115-global_mean), yend=(6.530115-global_mean), colour = cols[1], linewidth=1) +
  annotate(geom = "segment", x=0.7, xend=1.3, y=(8.323681-global_mean), yend=(8.323681-global_mean), colour = cols[2], linewidth=1) +
  annotate(geom = "segment", x=0.7, xend=1.3, y=(3.784875-global_mean), yend=(3.784875-global_mean), colour = cols[3], linewidth=1) +
...
comparing_variances_arrows <- comparing_variances_corrected +
  geom_segment(x=2.1, xend=2.1, y=1, yend=-1,
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), colour = "black", linewidth=1) +
...
between_group_small_diff <- ggplot(anova_small_diff, aes(x = as.factor(group), y = response)) +
  ...
  theme(legend.position = "none") +
  labs(title = "Between-group variance", x = "group", y = "response") +
  geom_segment(aes(xend = group, y = 6, yend = group_mean, colour = group), linewidth=1,
               arrow = arrow(ends = "both", length = unit(0.075, "inches"),
                             type = "closed"))
...
within_group_small_diff <- ggplot(anova_small_diff, aes(x = group, y = response)) +
  ...
  labs(title = "Within-group variance", x = "group", y = "residuals") +  
  geom_hline(yintercept = 6, linetype = "dashed") +
  geom_segment(aes(xend = group, y = (group_mean+1.9), yend = (group_mean-1.9), colour = group), linewidth = 1,
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"),
               position = position_nudge(x = 0.15))
...
```{r}
recap_threegroups <- intuitive_original + 
  theme_classic(base_size=17) +
  guides(colour="none")
  
square.ggsave(plot = recap_threegroups, filename = "plots/CS3-recap-threegroups.png")
```

```{r}
 recap_threegroups_null <- intuitive_original + 
  geom_hline(yintercept=6, linewidth=1, linetype=2) +
  labs(title="  ", x="group", y="response")

square.ggsave(plot = recap_threegroups_null, filename = "plots/CS3-recap-threegroups-null.png")
```
...
```{r, signal to noise in regression alternative version (BBS)}
signal_noise2 <- lm_xy %>%
  augment() %>% 
  mutate(.fitted = .fitted - mean(y)) %>% 
  ggplot() +
  geom_point(aes(x = "Residuals", y = .resid), size = 4, alpha = 0.5) +
  geom_point(aes(x = "Line of best fit", y = .fitted), colour = "#0072CF", size = 3, shape = 4, stroke = 1.5) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  ylim(-3, 3) +
  labs(title = "Signal vs noise", x = "", y = "") +
  theme_classic(base_size = 15)

square.ggsave(plot = signal_noise2, filename = "plots/cs3-signal-noise-2.png")
```
...
```{r}
scatterplot_resp_pred <- scatterplot_line +
  labs(title="Scatterplot of response vs predictor", x="predictor", y="response") +
  theme_classic(base_size=15)

square.ggsave(plot = scatterplot_resp_pred, filename = "plots/cs3-scatterplot-resp-pred.png")
```
...
overall_variance <- ggplot(xydat, aes(x = mean(x), y = y)) +
  ...
  xlim(0, 11) +
  ylim(0, 6) +
  labs(title = "Scatterplot of response only", y="response") +
  theme_classic(base_size = 15) +
  geom_segment(x=mean(xydat$x)+1, xend=mean(xydat$x)+1, y=mean(xydat$y)+1.7, yend=mean(xydat$y)-1.7,
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), colour = "#EA7125", linewidth=1)
...
diff_arrows <- ggplot(xydat, aes(x = x, y = y)) +
  ...
  geom_segment(x=mean(xydat$x), xend=mean(xydat$x), y=mean(xydat$y)+1.7, yend=mean(xydat$y)-0.1,
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), colour = "#0072CF", linewidth=1)
...
one_categorical <- ggplot(anova_example, aes(x = group, y = response, colour = group)) +
  geom_hline(yintercept = global_mean, linetype = "dashed", linewidth=1) +
  stat_summary(fun.y = mean, geom = "errorbar", aes(ymax = ..y.., ymin = ..y..), linewidth = 1) +
  geom_point(aes(colour = group), size = 3, alpha = 0.8) +
  scale_y_continuous(limits = c(0, 12), breaks = seq(0, 12, by = 2)) +
  scale_colour_manual(values = cols) +
  theme_classic(base_size = 15) +
...
one_continuous <- ggplot(xydat, aes(x = x, y = y)) +
  ...
  theme_classic(base_size = 15) +
  geom_smooth(method = "lm", se = FALSE, colour = "#0072CF", fullrange = TRUE, linewidth=1)
...
one_categorical_model <- ggplot(anova_example, aes(x = group, y = response)) +
  ...
  stat_summary(fun.y = mean, geom = "errorbar", aes(ymax = ..y.., ymin = ..y..), colour = "#0072CF", linewidth = 1) +
  scale_y_continuous(limits = c(0, 12), breaks = seq(0, 12, by = 2)) +
  scale_colour_manual(values = cols) +
  theme_classic(base_size = 15) +
  theme(legend.position = "none") +
...
careerdrink <- ggplot(racing, aes(x=career, colour=drink, group=drink, y=reaction)) +
  theme_classic(base_size=15) +  
  scale_colour_manual(values = cols) +
  geom_point(shape=4, size=2, stroke=1.25) +
  labs(y="reaction time (ms)", title="Reaction time by drink and career") +
  theme(legend.position = c(.25, .8))

interaction_careerdrink <- careerdrink +
  stat_summary(fun=mean, size=0.8) +
  stat_summary(fun=mean, geom="line", linewidth=1)

square.ggsave(plot = careerdrink, filename = "plots/cs4-careerdrink.png")
...
careerdrink2 <- ggplot(racing, aes(x=drink, colour=career, group=career, y=reaction)) +
  theme_classic(base_size=15) +  
...
interaction_careerdrink2 <- careerdrink2 +
  stat_summary(fun=mean, size=0.8) +
  stat_summary(fun=mean, geom="line", linewidth=1)

square.ggsave(plot = careerdrink2, filename = "plots/cs4-careerdrink2.png")
...
interaction_arrows_career <- interaction_careerdrink_iso +
  geom_segment(x=0.98, xend=1.98, y=175, yend=233,
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), colour = "black", linewidth=1) +
  geom_segment(x=0.98, xend=1.95, y=202, yend=328	,
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), colour = "black", linewidth=1)
...
treelight_raw <- ggplot(treelight, aes(x=Depth, colour=Species, group=Species, y=Light)) +
  ...
  scale_colour_manual(values = cols) +
  geom_point(size = 3) +
  labs(y="light intensity (lux)", x="depth", color="species", title="Light intensity by species and depth") +
...
data_plus_error <- simple_linear_model +
  geom_segment(x=4.75, xend=4.75, y=4.5, yend=3.7,
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), colour = "black", linewidth=1) +
  annotate(geom="point", shape=4, x=4.75, y=3.626, colour="#0072CF", size=4, stroke = 1.5)
...
data_error_categorical <- simple_categorical_model +
  annotate(geom="point", shape=4, x=2.1, y=8.32, colour="#0072CF", size=4, stroke = 1.5) +
  geom_segment(x=2.1, xend=2.1, y=8.4, yend=10.3,
               arrow = arrow(ends = "both", length = unit(0.075, "inches"), type = "closed"), colour = "black", linewidth=1)
...
twoway_model <- ggplot(racing, aes(x=career, shape=drink, group=drink, y=reaction)) +
  theme_classic(base_size=15) + 
  #scale_shape_manual(values = c(caffeine = 16, water = 4)) + 
  geom_point(alpha = 0.8, size = 2, stroke=1.25, colour="#999999") +
  stat_summary(fun=mean, size=0.8, stroke=1.5, colour="#0072CF") +
  stat_summary(fun=mean, geom="line", linewidth=1, colour="#0072CF") +
  labs(y="reaction time (ms)", x="career", shape="drink", title="Two-way ANOVA") +
...
landscape.ggsave(plot = twoway_model, filename = "plots/cs5-twoway-categorical-predictors.png")
...
equation_step3 <- twoway_model +
  ...
  annotate(geom="segment", x=1, xend=2, y=193.0914, yend=251.0514, colour="#EA7125", linetype=2, linewidth=1)
...
twogroup_model <- ggplot(treelight, aes(x=Depth, shape=Species, group=Species, y=Light)) +
  ...
  labs(y="response", x="predictor 1", shape="predictor 2", title="Grouped linear regression") +
...
landscape.ggsave(plot = twogroup_model, filename = "plots/cs5-grouped-linear-reg.png")
```
...
twogroup_interaction <- twogroup_model +
  annotate(geom="segment", x=1, xend=10, y=4721.821, yend=2802.69, colour="#EA7125", linetype=2, linewidth=1)
...
b1 <- 0.65
b2 <- c(0, 1, -1)
avg_weight <- b0 + b1*height + model.matrix(~ 0 + identity) %*% b2
weight <- rnorm(n, avg_weight, 3)

survey <- tibble(height, identity, weight)

cols <- c("Northern" = "#EA7125", "Southern" = "#8F2BBC", "Other" = "#00B1C1")
```
...
null_dist <- ggplot(NULL, aes(c(-2,2))) +
  ...
  geom_area(stat = "function", fun = dnorm, args=list(mean=0, sd=0.5), fill = "grey95", colour = "#0072CF", linewidth = 1, xlim = c(-2, 2)) +
...
five_percent <- ggplot(NULL, aes(c(-2,2))) +
  geom_hline(yintercept = 0, colour = "grey70", size = 0.25) +  
  geom_area(stat = "function", fun = dnorm, args=list(mean=0, sd=0.5), fill = "grey95", colour = "#0072CF", linewidth = 1, xlim = c(-2, 1)) +
  geom_vline(xintercept = 0, linetype = "dashed", size = 0.5, colour = "#0072CF") +    
  geom_area(stat = "function", fun = dnorm, args=list(mean=0, sd=0.5), fill = "#0072CF", colour = "#0072CF", linewidth = 1, xlim = c(1, 2)) +
  geom_area(stat = "function", fun = dnorm, args=list(mean=0, sd=0.5), fill = "#0072CF", colour = "#0072CF", linewidth = 1, xlim = c(-2, -1))  +
  labs(title = "Gene expression distribution", x = "log2 fold change", y = "probability density") +
  theme_classic(base_size=15) +
  annotate(geom = "text", x=-1.5, y=0.6, label = "5%", size = 10, colour = "#003E72") +
...
one_percent <- ggplot(NULL, aes(c(-2,2))) +
  geom_hline(yintercept = 0, colour = "grey70", size = 0.25) +  
  geom_area(stat = "function", fun = dnorm, args=list(mean=0, sd=0.5), fill = "grey95", colour = "#0072CF", linewidth = 1, xlim = c(-2, 1.25)) +
  geom_vline(xintercept = 0, linetype = "dashed", size = 0.5, colour = "#0072CF") +    
  geom_area(stat = "function", fun = dnorm, args=list(mean=0, sd=0.5), fill = "#0072CF", colour = "#0072CF", linewidth = 1, xlim = c(1.25, 2)) +
  geom_area(stat = "function", fun = dnorm, args=list(mean=0, sd=0.5), fill = "#0072CF", colour = "#0072CF", linewidth = 1, xlim = c(-2, -1.25))  +
  labs(title = "Gene expression distribution", x = "log2 fold change", y = "probability density") +
  theme_classic(base_size=15) +
  annotate(geom = "text", x=-1.5, y=0.6, label = "1%", size = 10, colour = "#003E72") +
  geom_segment(x=-1.5, y=0.8, xend=-1.25, yend=0.1, arrow = arrow(ends = "last", length = unit(0.05, "inches"), type = "closed"), colour = "black") +
  geom_segment(x=-1.5, y=0.5, xend=0.9, yend=0.1, arrow = arrow(ends = "last", length = unit(0.05, "inches"), type = "closed"), colour = "black")  
...
decreased_var <- ggplot(NULL, aes(c(-2,6))) +
  geom_hline(yintercept = 0, colour = "grey70", size = 0.25) +  
  annotate(xmin = -0.5, xmax = 0.5, ymin = -Inf, ymax = Inf, geom = 'rect', alpha = 0.2, colour = "#999999") +
  labs(title = "Gene expression distribution", x = "log2 fold change", y = "probability density") +
  theme_classic(base_size=15) +
  xlim(-2, 6) +
  ...
  geom_vline(xintercept = 0, linetype = "dashed", linewidth = 0.25, colour = "black") +
  geom_vline(xintercept = 1.75, linetype = "dashed", linewidth = 0.25, colour = "black")
...
meaning <- ggplot(bigdrug, aes(x=group, y=response, colour=group)) +
  geom_boxplot(show.legend = FALSE, linewidth = 0.75) +
...
nonmeaning <- ggplot(smalldrug, aes(x=group, y=response, colour=group)) +
  geom_boxplot(show.legend = FALSE, linewidth = 0.75) +
  labs(title = "Non-meaningful effect size", x = "drug", y = "duration of pain relief (mins)") +
  theme_classic(base_size=15) +
  ylim(440,560) +
  scale_colour_manual(values = cols) +
  annotate(geom="text", label=lbp, parse=TRUE, x=1, y=550, size=6) +
...
#### Multiple samples from null distribution (old version)
...
landscape.ggsave(plot = probfalsepositive, filename = "plots/cs6-probfalsepositive.png")
```
...
landscape.ggsave(plot = probfalsepositive_breakeven, filename = "plots/cs6-probfalsepositive_breakeven.png")
```
...
landscape.ggsave(plot = realitypopulationnull, filename = "plots/cs6-realitypopulationnull.png")
...
landscape.ggsave(plot = realitypopulationlarge, filename = "plots/cs6-realitypopulationlarge.png")
```
...
landscape.ggsave(plot = realitypopulationsmall, filename = "plots/cs6-realitypopulationsmall.png")
```
...
landscape.ggsave(plot = fwer_randomtests, filename = "plots/cs6-fwer_randomtests.png")
```
...
landscape.ggsave(plot = fwer_randomtests_sig, filename = "plots/cs6-fwer_randomtests_sig.png")
```
...
landscape.ggsave(plot = fwer_bonferroni, filename = "plots/cs6-fwer_bonferroni.png")
```
...
landscape.ggsave(plot = fwer_bonferroni_mult, filename = "plots/cs6-fwer_bonferroni_mult.png")
```
...
landscape.ggsave(plot = fwer_compare_base, filename = "plots/cs6-fwer_compare_base.png")
```
...
landscape.ggsave(plot = fwer_compare_base_threshold, filename = "plots/cs6-fwer_compare_base_threshold.png")
```
...
fwer_compare_true_negatives <- ggplot(fwer_comparison, aes(x = group_index, y = pval_all, colour = pval_all >= 0.05 & group == "boring")) +
  ...
  labs(title = "True negatives",
       x = "test index",
       y = "p-value") +
  scale_colour_manual(values = c("#999999","#0072CF")) +
  theme(legend.position = "none",
         strip.background = element_blank())

landscape.ggsave(plot = fwer_compare_true_negatives, filename = "plots/cs6-fwer_compare_true_negatives.png")
```
...
landscape.ggsave(plot = fwer_compare_false_positives, filename = "plots/cs6-fwer_compare_false_positives.png")
```
...
landscape.ggsave(plot = fwer_compare_true_positives, filename = "plots/cs6-fwer_compare_true_positives.png")
```
...
landscape.ggsave(plot = fwer_compare_false_negatives, filename = "plots/cs6-fwer_compare_false_negatives.png")
```
...
landscape.ggsave(plot = fwer_compare_whatwesee, filename = "plots/cs6-fwer_compare_whatwesee.png")
```
...
landscape.ggsave(plot = fwer_compare_bonferroni, filename = "plots/cs6-fwer_compare_bonferroni.png")
```
...
landscape.ggsave(plot = fwer_compare_sidak, filename = "plots/cs6-fwer_compare_sidak.png")
```
...
landscape.ggsave(plot = fwer_compare_holm, filename = "plots/cs6-fwer_compare_holm.png")
```
...
landscape.ggsave(plot = fwer_compare_FDR, filename = "plots/cs6-fwer_compare_FDR.png")
```
